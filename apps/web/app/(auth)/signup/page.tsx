  ...
  if (done) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        {bgLayers}
        <div className="relative w-full max-w-sm rounded-2xl border border-white/8 bg-card/80 backdrop-blur-sm p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_32px_64px_rgba(0,0,0,0.5)] text-center space-y-3">
          ...
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-primary/10 border border-primary/20 text-primary mx-auto mb-2">
          ...
          <Link
            href="/login"
            className="inline-block mt-2 text-sm text-muted-foreground/60 hover:text-foreground transition-colors"
          >
            ← Back to sign in
          </Link>
        </div>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="relative rounded-2xl border border-white/8 bg-card/80 backdrop-blur-sm p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_32px_64px_rgba(0,0,0,0.5)]">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-medium text-muted-foreground mb-1.5">
                Password
                <span className="ml-1 font-normal opacity-50">(min. 8 characters)</span>
              </label>
              <input
                id="password"
                type="password"
          ...
          <p className="mt-5 text-center text-xs text-muted-foreground/60 border-t border-border/60 pt-5">
